...
public class Ex3_Dateformat {
	...
	public static void main(String[] args) {
		...
		String Qdate = sdf.format(question1.createDate);
		System.out.println(Qdate);

		//Q4
		SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy");
		String Qdate1 = sdf1.format(question2.createDate);
		System.out.println(Qdate1);

		//Q5.
		SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM");
		String Qdate2 = sdf2.format(question2.createDate);
		System.out.println(Qdate2);

		//Q6.
		SimpleDateFormat sdf3 = new SimpleDateFormat("MM-dd");
		String Qdate3 = sdf3.format(question2.createDate);
